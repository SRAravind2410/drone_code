...
void ModeZigZag::manual_control()
{
    ...
    case AltHoldModeState::MotorStopped:
        ...
        loiter_nav->init_target();
        attitude_control->input_euler_angle_roll_pitch_euler_rate_yaw(loiter_nav->get_roll_cd(), loiter_nav->get_pitch_cd(), target_yaw_rate);
        break;
...
{
    return is_auto ? wp_nav->get_wp_bearing_to_destination_cdeg() : 0;
}
